...
public class XmlSchemaTemplate {
  ...
  public Schema createSchemaModel() {
    Schema _xblockexpression = null;
    {
      ...
      SchemaBuilder _schemaBuilder = new SchemaBuilder(_function);
      final SchemaBuilder builder = _schemaBuilder;
      SimpleType _simpleType = builder.simpleType(this.uuid, DataType.STRING);
      ...
      ComplexType _complexType = builder.complexType(this.identityReference, _function_1);
      final ComplexType identityReference = _complexType;
      Element _element = builder.element(this.semanticIdentity, identityReference);
      final Element semanticIdentityElement = _element;
      Element _element_1 = builder.element(this.isAbstract, identityReference);
      final Element isAbstractElement = _element_1;
      Element _element_2 = builder.element(this.minCardinality, identityReference);
      final Element minCardinalityElement = _element_2;
      Element _element_3 = builder.element(this.maxCardinality, identityReference);
      final Element maxCardinalityElement = _element_3;
      Element _element_4 = builder.element(this.isContainer, identityReference);
      final Element isContainerElement = _element_4;
      Element _element_5 = builder.element(this.isNavigable, identityReference);
      final Element isNavigableElement = _element_5;
      Element _element_6 = builder.element(this.from, identityReference);
      final Element fromElement = _element_6;
      Element _element_7 = builder.element(this.to, identityReference);
      final Element toElement = _element_7;
      Element _element_8 = builder.element(this.category, identityReference);
      ...
      ComplexType _complexType_1 = builder.complexType(this.category, _function_2);
      ...
      ComplexType _complexType_2 = builder.complexType(this.vertex, _withExtension);
      ...
      ComplexType _complexType_3 = builder.complexType(this.visibility, _withExtension_1);
      ...
      ComplexType _complexType_4 = builder.complexType(this.superSetReference, _withExtension_2);
      ...
      ComplexType _complexType_5 = builder.complexType(this.edgeEnd, _withExtension_3);
          ...
          public void apply(final Sequence it) {
            {
              ...
              CollectionExtensions.<ElementReference>operator_add(_children, _element);
              List<Node> _children_1 = it.getChildren();
              Element _element_1 = builder.element(XmlSchemaTemplate.this.from, edgeEndComplexType);
              CollectionExtensions.<Element>operator_add(_children_1, _element_1);
              List<Node> _children_2 = it.getChildren();
              Element _element_2 = builder.element(XmlSchemaTemplate.this.to, edgeEndComplexType);
      ...
      ComplexType _complexType_6 = builder.complexType(this.edge, _withExtension_4);
      ...
      Extension _withExtension_5 = SchemaBuilder.withExtension(categoryComplexType, _function_8);
      ...
      ComplexType _complexType_8 = builder.complexType(this.function, _withExtension_6);
      final ComplexType functionComplexType = _complexType_8;
      final Procedure1<Sequence> _function_10 = new Procedure1<Sequence>() {
          public void apply(final Sequence it) {
          }
        };
      Extension _withExtension_7 = SchemaBuilder.withExtension(functionComplexType, _function_10);
      ComplexType _complexType_9 = builder.complexType(this.command, _withExtension_7);
      final ComplexType commandComplexType = _complexType_9;
      final Procedure1<Sequence> _function_11 = new Procedure1<Sequence>() {
          public void apply(final Sequence it) {
          }
        };
      Extension _withExtension_8 = SchemaBuilder.withExtension(functionComplexType, _function_11);
      ComplexType _complexType_10 = builder.complexType(this.query, _withExtension_8);
          ...
          public void apply(final Sequence it) {
            {
              ...
              CollectionExtensions.<ElementReference>operator_add(_children_1, _element_1);
              List<Node> _children_2 = it.getChildren();
              Element _element_2 = builder.element(XmlSchemaTemplate.this.vertex, vertexComplexType, Cardinality.ZERO_TO_MANY);
              CollectionExtensions.<Element>operator_add(_children_2, _element_2);
              List<Node> _children_3 = it.getChildren();
              Element _element_3 = builder.element(XmlSchemaTemplate.this.visibility, visibilityComplexType, Cardinality.ZERO_TO_MANY);
              CollectionExtensions.<Element>operator_add(_children_3, _element_3);
              List<Node> _children_4 = it.getChildren();
              Element _element_4 = builder.element(XmlSchemaTemplate.this.edge, edgeComplexType, Cardinality.ZERO_TO_MANY);
              CollectionExtensions.<Element>operator_add(_children_4, _element_4);
              List<Node> _children_5 = it.getChildren();
              Element _element_5 = builder.element(XmlSchemaTemplate.this.superSetReference, superSetReferenceComplexType, Cardinality.ZERO_TO_MANY);
              CollectionExtensions.<Element>operator_add(_children_5, _element_5);
              List<Node> _children_6 = it.getChildren();
              Element _element_6 = builder.element(XmlSchemaTemplate.this.command, commandComplexType, Cardinality.ZERO_TO_MANY);
              CollectionExtensions.<Element>operator_add(_children_6, _element_6);
              List<Node> _children_7 = it.getChildren();
              Element _element_7 = builder.element(XmlSchemaTemplate.this.query, queryComplexType, Cardinality.ZERO_TO_MANY);
              CollectionExtensions.<Element>operator_add(_children_7, _element_7);
            }
          }
        };
      Extension _withExtension_9 = SchemaBuilder.withExtension(categoryComplexType, _function_12);
      ComplexType _complexType_11 = builder.complexType(this.graph, _withExtension_9);
      final ComplexType graphComplexType = _complexType_11;
      final Procedure1<Sequence> _function_13 = new Procedure1<Sequence>() {
          public void apply(final Sequence it) {
          }
        };
      Extension _withExtension_10 = SchemaBuilder.withExtension(graphComplexType, _function_13);
      ComplexType _complexType_12 = builder.complexType(this.model, _withExtension_10);
      final ComplexType modelComplexType = _complexType_12;
      Element _element_9 = builder.element(this.model, modelComplexType);
      ...
      ComplexType _complexType_13 = builder.complexType(_identity, _function_14);
      ...
      ComplexType _complexType_14 = builder.complexType(_semanticDomain, _function_15);
      final ComplexType semanticDomainComplexType = _complexType_14;
      String _artifactSet = this.terminology.artifactSet();
      final Procedure1<Sequence> _function_16 = new Procedure1<Sequence>() {
          public void apply(final Sequence it) {
            {
              List<Node> _children = it.getChildren();
      ...
      ComplexType _complexType_15 = builder.complexType(_artifactSet, _function_16);
      ...
      Schema _schema = builder.getSchema();
      _xblockexpression = (_schema);
    }
