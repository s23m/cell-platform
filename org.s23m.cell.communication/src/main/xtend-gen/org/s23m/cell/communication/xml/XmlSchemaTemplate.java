...
public class XmlSchemaTemplate {
  ...
  private CharSequence reusedElements() {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("\t");
    final String identityReference = "identityReference";
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    String _s23m = this.s23m(identityReference);
    final String identityReferenceQualified = _s23m;
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    final String uuid = "uuid";
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    final String semanticIdentity = "semanticIdentity";
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    final String isAbstract = "isAbstract";
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    final String maxCardinality = "maxCardinality";
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    CharSequence _element = this.element(semanticIdentity, identityReferenceQualified);
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_2 = this.element(category, identityReferenceQualified);
    _builder.append(_element_2, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_3 = this.element(isAbstract, identityReferenceQualified);
    _builder.append(_element_3, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_4 = this.element(maxCardinality, identityReferenceQualified);
    _builder.append(_element_4, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_5 = this.element("minCardinality", identityReferenceQualified);
    _builder.append(_element_5, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_6 = this.element("isContainer", identityReferenceQualified);
    _builder.append(_element_6, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_7 = this.element("isNavigable", identityReferenceQualified);
    _builder.append(_element_7, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_8 = this.element("from", identityReferenceQualified);
    _builder.append(_element_8, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    CharSequence _element_9 = this.element("to", identityReferenceQualified);
    _builder.append(_element_9, "	");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    String _s23m_2 = this.s23m("function");
    CharSequence _element_10 = this.element("function", _s23m_2);
    _builder.append(_element_10, "	");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("\t");
    String _s23m_3 = this.s23m(uuid);
    CharSequence _element_11 = this.element("uniqueRepresentationReference", _s23m_3);
    String _s23m_4 = this.s23m(uuid);
    CharSequence _element_12 = this.element("identifier", _s23m_4);
    ...
    _builder.newLine();
    _builder.append("\t");
    String _s23m_5 = this.s23m(semanticIdentity);
    CharSequence _element_13 = this.element(_s23m_5);
    String _s23m_6 = this.s23m(category);
    CharSequence _element_14 = this.element(_s23m_6);
