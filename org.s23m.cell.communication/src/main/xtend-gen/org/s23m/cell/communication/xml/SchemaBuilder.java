...
public class SchemaBuilder {
  ...
  public static Element element(final Namespace namespace, final String name, final SimpleType type) {
  ...
  public static Element element(final Namespace namespace, final String name, final SimpleType type, final Procedure1<? super Element> initialiser) {
    Element _element = SchemaBuilder.element(namespace, name, type, Cardinality.EXACTLY_ONE, initialiser);
    return _element;
  }
  
  public static Element element(final Namespace namespace, final String name, final SimpleType type, final Cardinality cardinality, final Procedure1<? super Element> initialiser) {
  ...
  public static Element element(final Namespace namespace, final String name, final ComplexType type) {
    final Procedure1<Element> _function = new Procedure1<Element>() {
        public void apply(final Element it) {
        }
      };
  ...
  public static Element element(final Namespace namespace, final String name, final ComplexType type, final Procedure1<? super Element> initialiser) {
    Element _element = SchemaBuilder.element(namespace, name, type, Cardinality.EXACTLY_ONE, initialiser);
    return _element;
  }
  
  public static Element element(final Namespace namespace, final String name, final ComplexType type, final Cardinality cardinality, final Procedure1<? super Element> initialiser) {
    Element _xblockexpression = null;
    {
      Element _element = new Element(namespace, name, type, cardinality);
      final Element result = _element;
