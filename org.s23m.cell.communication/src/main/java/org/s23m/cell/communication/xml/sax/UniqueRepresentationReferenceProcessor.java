...
public class UniqueRepresentationReferenceProcessor implements SaxElementProcessor<UniqueRepresentationReference> {

	@Override
	public UniqueRepresentationReference startElement(Namespace namespace, XmlSchemaTerminology terminology, Node top) {
		return new UniqueRepresentationReference(namespace, terminology);
	}

	@Override
	public void endElement(Node removed, Node top, String textContent) {
		final UniqueRepresentationReference reference = (UniqueRepresentationReference) removed;
