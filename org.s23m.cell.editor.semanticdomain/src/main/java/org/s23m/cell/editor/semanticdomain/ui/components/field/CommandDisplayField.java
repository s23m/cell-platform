...
public class CommandDisplayField extends CustomField implements Container.Viewer {
	...
	public CommandDisplayField(final String title, final BeanItemContainer<SetData> container) {
