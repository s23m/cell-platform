...
public class IdentityFactory implements KernelIdentities {
	...
	public final 	Identity edgeTrace() {return createIdentityInKernel("edge trace" , "edge traces", SemanticIdentityRegistry.DEPRECATED_edgeTrace.ordinal());}
	...
	public final	Identity filterProperClass() {return createIdentityInKernel("filterProperClass" , "filterProperClass", SemanticIdentityRegistry.filterProperClass.ordinal());}
	...
	public final	Identity filterArrows() {return createIdentityInKernel("filterArrows" , "filterArrows", SemanticIdentityRegistry.filterArrows.ordinal());}
	...
	public final	Identity isAnArrow() {return createIdentityInKernel("isAnArrow" , "isAnArrow", SemanticIdentityRegistry.isAnArrow.ordinal());}
	...
	public final	Identity semanticErr_AddAbstractIsOnlyValidForAbstractVertex() {return createIdentityInKernel("addAbstract(category, semanticIdentity) is only valid for abstract Vertex Instances" , "addConcrete(category, semanticIdentity) is only valid for abstract Vertex Instances", SemanticIdentityRegistry.semanticErr_AddAbstractIsOnlyValidForAbstractVertex.ordinal());}
	public final	Identity semanticErr_AddConcreteIsOnlyValidForConcreteVertex() {return createIdentityInKernel("addConcrete(category, semanticIdentity) is only valid for concrete Vertex Instances" , "addConcrete(category, semanticIdentity) is only valid for concrete Vertex Instances", SemanticIdentityRegistry.semanticErr_AddConcreteIsOnlyValidForConcreteVertex.ordinal());}
	...
	public final	Identity semanticErr_ArrowIsNotApplicable() {return createIdentityInKernel("arrow(isInformation, fromInstance, toInstance) is NOTAPPLICABLE" , "arrow(isInformation, fromInstance, toInstance) is only applicable when the isInformation is a visibility, DEPRECATED_edgeTrace, or generalizationReference instance", SemanticIdentityRegistry.semanticErr_ArrowIsNotApplicable.ordinal());}
	...
	public final	Identity semanticErr_OnlyEdgeEndInstancesHaveEdgeEndVertex() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edgeEnds instances have an edgeEndVertex", SemanticIdentityRegistry.semanticErr_OnlyEdgeEndsHaveEdgeEndVertex.ordinal());}
	public final	Identity semanticErr_OnlyEdgeEndInstancesHaveIsContainer() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edgeEnds instances have an isContainer value", SemanticIdentityRegistry.semanticErr_OnlyEdgeEndsHaveIsContainer.ordinal());}
	public final	Identity semanticErr_OnlyEdgeEndInstancesHaveIsNavigable() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edgeEnds instances have an isNavigable value", SemanticIdentityRegistry.semanticErr_OnlyEdgeEndsHaveIsNavigable.ordinal());}
	public final	Identity semanticErr_OnlyEdgeEndInstancesHaveMaxCardinality() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edgeEnds instances have a maxCardinality value", SemanticIdentityRegistry.semanticErr_OnlyEdgeEndsHaveMaxCardinality.ordinal());}
	public final	Identity semanticErr_OnlyEdgeEndInstancesHaveMinCardinality() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edgeEnds instances have a minCardinality value", SemanticIdentityRegistry.semanticErr_OnlyEdgeEndsHaveMinCardinality.ordinal());}
	public final	Identity semanticErr_OnlyEdgeInstancesHaveConnectedInstances() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edge instances have connected to/fromInstances", SemanticIdentityRegistry.semanticErr_OnlyEdgesHaveConnectedInstances.ordinal());}
	public final	Identity semanticErr_OnlyEdgeInstancesHaveConnectedRoles() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edge instances have connected to/fromRoles", SemanticIdentityRegistry.semanticErr_OnlyEdgesHaveConnectedRoles.ordinal());}
	public final	Identity semanticErr_OnlyEdgeInstancesHaveEdgeEnds() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only edge instances have edgeEnds", SemanticIdentityRegistry.semanticErr_OnlyEdgesHaveEdgeEnds.ordinal());}
	public final	Identity semanticErr_OnlyEdgeTraceInstancesHaveAbstraction() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only DEPRECATED_edgeTrace instances have an abstraction", SemanticIdentityRegistry.semanticErr_OnlyEdgeTracesHaveAbstraction.ordinal());}
	public final	Identity semanticErr_OnlyEdgeTraceInstancesHaveDetail() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only DEPRECATED_edgeTrace instances have a detail", SemanticIdentityRegistry.semanticErr_OnlyEdgeTracesHaveDetail.ordinal());}
	...
	public final	Identity semanticErr_OnlySuperSetReferenceInstancesHaveSubSet() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only generalizationReference instances have a specialization", SemanticIdentityRegistry.semanticErr_OnlySuperSetReferencesHaveSubSet.ordinal());}
	public final	Identity semanticErr_OnlySuperSetReferenceInstancesHaveSuperSet() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only generalizationReference instances have a generalization", SemanticIdentityRegistry.semanticErr_OnlySuperSetReferencesHaveSuperSet.ordinal());}
	...
	public final	Identity semanticErr_OnlyVisibilityInstancesHaveFromSubGraph() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only visibility instances have a fromSubGraph", SemanticIdentityRegistry.semanticErr_OnlyVisibilitiesHaveFromSubGraph.ordinal());}
	public final	Identity semanticErr_OnlyVisibilityInstancesHaveToSubGraph() {return createIdentityInKernel("operation is NOTAPPLICABLE" , "Only visibility instances have a toSubGraph", SemanticIdentityRegistry.semanticErr_OnlyVisibilitiesHaveToSubGraph.ordinal());}
	...
	public final	Identity semanticErr_TargetIsNotWithinVisibility() {return createIdentityInKernel("target of arrow is NOTWITHINVISIBILITY" , "the target of an AbstractEdge arrow must be within the range of visibilities defined in the category of the source", SemanticIdentityRegistry.semanticErr_TargetIsNotWithinVisibility.ordinal());}
